...
% Old IGN template colors
\definecolorstyle{Steph}{
    % Define default colors
    % GrayBlueYellow
    \definecolor{colorOne}{HTML}{FFFFFF}
    \definecolor{colorTwo}{HTML}{A3D20B}%IGNVert
    \definecolor{colorThree}{HTML}{9FA4A8}%IGNGris
    \definecolor{colorFour}{HTML}{65696E}%IGNGrisFonce
}{
     % Background Colors
