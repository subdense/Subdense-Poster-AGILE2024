...
%% 
 ...
 % My custom note style for the "journées de la recherche IGN" block at the bottom of the poster
 % It is a kind of invisible block, except that it is visible but with the same borders as the poster's background
 \definenotestyle{Steph}{
    targetoffsetx=0pt, targetoffsety=0pt, angle=0, radius=5cm, width=20cm,
    ...
    \draw[color=white, fill=white, rounded
